...
with mp_pose.Pose(min_detection_confidence=0.80, min_tracking_confidence=0.5, model_complexity = 2, static_image_mode = False,enable_segmentation = True) as pose: 
    while cap.isOpened():
        ...
        if results.pose_world_landmarks:
            ...
            data += "{}|{}|{}|{}|{}\n".format(3,right_shoulder_rotation["euler"][0],right_shoulder_rotation["euler"][1],right_shoulder_rotation["euler"][2],right_shoulder_rotation["visibility"])
            data += "{}|{}|{}|{}|{}\n".format(4,left_elbow_rotation["euler"][0],left_elbow_rotation["euler"][1],left_elbow_rotation["euler"][2],left_elbow_rotation["visibility"])
            data += "{}|{}|{}|{}|{}\n".format(5,right_elbow_rotation["euler"][0],right_elbow_rotation["euler"][1],right_elbow_rotation["euler"][2],right_elbow_rotation["visibility"])
            data += "{}|{}|{}|{}|{}\n".format(6,left_hip_rotation["euler"][0],left_hip_rotation["euler"][1],left_hip_rotation["euler"][2],left_hip_rotation["visibility"])
            data += "{}|{}|{}|{}|{}\n".format(7,right_hip_rotation["euler"][0],right_hip_rotation["euler"][1],right_hip_rotation["euler"][2],right_hip_rotation["visibility"])
            data += "{}|{}|{}|{}|{}\n".format(8,left_knee_rotation["euler"][0],left_knee_rotation["euler"][1],left_knee_rotation["euler"][2],left_knee_rotation["visibility"])
            data += "{}|{}|{}|{}|{}\n".format(9,right_knee_rotation["euler"][0],right_knee_rotation["euler"][1],right_knee_rotation["euler"][2],right_knee_rotation["visibility"])
