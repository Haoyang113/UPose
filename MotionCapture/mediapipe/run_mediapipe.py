...
with mp_pose.Pose(min_detection_confidence=0.80, min_tracking_confidence=0.5, model_complexity = 2, static_image_mode = False,enable_segmentation = True) as pose: 
    while cap.isOpened():
        ...
        if results.pose_world_landmarks:
            ...
            data += "{}|{}|{}|{}|{}\n".format(0,pelvis_rotation[0],pelvis_rotation[1],pelvis_rotation[2],pelvis_rotation[3])
            data += "{}|{}|{}|{}|{}\n".format(1,torso_rotation[0],torso_rotation[1],torso_rotation[2],torso_rotation[3])
            data += "{}|{}|{}|{}|{}\n".format(2,left_shoulder_rotation[0],left_shoulder_rotation[1],left_shoulder_rotation[2],left_shoulder_rotation[3])
            data += "{}|{}|{}|{}|{}\n".format(3,right_shoulder_rotation[0],right_shoulder_rotation[1],right_shoulder_rotation[2],right_shoulder_rotation[3])
            data += "{}|{}|{}|{}|{}\n".format(4,left_elbow_rotation[0],left_elbow_rotation[1],left_elbow_rotation[2],left_elbow_rotation[3])
            data += "{}|{}|{}|{}|{}\n".format(5,right_elbow_rotation[0],right_elbow_rotation[1],right_elbow_rotation[2],right_elbow_rotation[3])
            data += "{}|{}|{}|{}|{}\n".format(6,left_hip_rotation[0],left_hip_rotation[1],left_hip_rotation[2],left_hip_rotation[3])
            data += "{}|{}|{}|{}|{}\n".format(7,right_hip_rotation[0],right_hip_rotation[1],right_hip_rotation[2],right_hip_rotation[3])
            data += "{}|{}|{}|{}|{}\n".format(8,left_knee_rotation[0],left_knee_rotation[1],left_knee_rotation[2],left_knee_rotation[3])
            data += "{}|{}|{}|{}|{}\n".format(9,right_knee_rotation[0],right_knee_rotation[1],right_knee_rotation[2],right_knee_rotation[3])
