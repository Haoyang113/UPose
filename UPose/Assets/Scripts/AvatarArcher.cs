...
public class AvatarArcher : MonoBehaviour
{
    ...
    private async void InitializeAvatar(){
        ...
        if (success) {
            ...
            //create an instance of the object you need to hold
            //set the localPosition by obj.transform.localPosition=new Vector3(x,y,z);
            //set the localPosition by obj.transform.localRotation = Quatornian.Euler(rotX,rotY,rotZ);
            //set parent by: obj.transform.SetParent(RightHand);
